...
-- Run this after creating the demo user in Supabase Auth
...
-- Create demo user profile (using actual auth user ID)
...
-- Summary: Created demo data with:
-- • 1 company: Demo Fleet Management
-- • 1 user: Demo Owner (a696b48c-f756-41f0-b10f-fb7428328b51)
-- • 5 vehicles: Ford F-150, Toyota Camry, Chevy Silverado, Honda Civic, Ram 1500
-- • 10 maintenance records with costs totaling $1,091.98
-- • 5 future maintenance recommendations
-- • 1 custom maintenance type